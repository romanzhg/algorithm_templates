// DFS with optimality pruning, new branch should not be worse than
// existing answer. This approach is easier to implement but is slower
// than Iterative Deepening, since the program may spend some time
// in a deep branch.
#include <cfloat>
#include <climits>
#include <cmath>
